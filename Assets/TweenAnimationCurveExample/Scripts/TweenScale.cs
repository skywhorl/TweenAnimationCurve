...
public class TweenScale : MonoBehaviour
{
    ...
    [Header("초기 기준 크기")][SerializeField] Vector3 from;
    [Header("목표 기준 크기")][SerializeField] Vector3 to;
    [Header("재생 시간")][SerializeField] float duration = 1f;

    // true 시 Animation 작동
    // ====== 다른 Script에서 해당 변수를 제어하려면 Play() 함수 사용 ====== //
    [Header("Animation 재생 여부")] public bool startAnimation;
    ...
    void SetValue(float curveTime)
    {
        ...
        // 해당 값을 현재 크기에 대입
        // 만약 World 기준으로 설정해야 한다면 lossyScale로 수정
